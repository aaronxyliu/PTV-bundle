...
async function installScriptInterceptor(page, stats) {
  ...
  client.on("Fetch.requestPaused", async (event) => {
    ...
    try {
      ...
      scriptReport.requireName = transformed.metadata.requireName || "";
      scriptReport.moduleIdParameter = transformed.metadata.moduleIdParameter || "";
      scriptReport.exposedEntryRequires = transformed.metadata.exposedEntryRequires || [];
